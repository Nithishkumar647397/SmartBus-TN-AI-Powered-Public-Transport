    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.colors.background }]}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { color: theme.colors.text }]}>Find a Bus</Text>
        </View>

        <View style={styles.searchSection}>
          <View style={[styles.originChip, { backgroundColor: '#E8F5E9' }]}>
            <MaterialIcons name="my-location" size={18} color="#4CAF50" />
            <Text style={[styles.originText, { color: '#4CAF50' }]}>From: {origin}</Text>
          </View>
          ...
          <Surface style={[styles.searchContainer, { elevation: 2, backgroundColor: theme.colors.surface }]} >
            ...
            {destinationQuery.length > 0 && (
               <TouchableOpacity onPress={() => handleSearch('')}>
                 <MaterialIcons name="close" size={20} color={theme.colors.secondaryText || '#757575'} />
               </TouchableOpacity>
            )}
          </Surface>
...
const styles = StyleSheet.create({
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', borderRadius: 16, paddingHorizontal: 16, height: 56, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 10, shadowOffset: {width:0, height:4} },
  searchIcon: { marginRight: 12 },
  searchInput: { flex: 1, fontSize: 16, height: '100%' },
  
  suggestionsContainer: { marginTop: 8, borderRadius: 16, maxHeight: 200, overflow: 'hidden', position: 'absolute', top: 140, left: 24, right: 24, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 10, shadowOffset: {width:0, height:6} },
  suggestionItem: { flexDirection: 'row', alignItems: 'center', padding: 16 },
  suggestionText: { marginLeft: 12, fontSize: 16 },
  separator: { height: 1 },
